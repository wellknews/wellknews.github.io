...
export const wellknews1k: Session = {
  ...
  body: (
    <>
      ...
      <Scene air>
        <Passage tone="loud">
          <p>하나쯤은 물건으로 남겨보기로 했다.</p>
        </Passage>
      </Scene>

      <Scene>
        <Candidates options={['KEYCAP', 'T-SHIRT', 'ECO BAG', 'MOUSE PAD']} chosen="T-SHIRT" />

        <Passage>
          <p>가장 먼저 만들 수 있었던 것.</p>
        </Passage>
      </Scene>
