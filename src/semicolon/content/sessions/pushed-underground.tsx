...
export const pushedUnderground: Session = {
  ...
  /*
   * 목록의 판에 오르는 장면들. 그날 실제로 남은 순서 그대로다.
   *
   * 강남의 줄과 보울이 먼저 오고 그다음이 지하의 아홉 장이다. 이 하루가
   * 판에서 가장 넓은 자리를 차지하는데, 그것이 지어낸 강조가 아니라 사실이다 —
   * 사진이 열한 장 남은 하루이기 때문이다.
   */
  images: [line, bowl, ...underground],
  guide: (
    <>
