...
export const pleasureIsNotASin: Session = {
  ...
  guide: (
    <>
      <p>이날의 시작은 최예나의 앙코르 콘서트였다.</p>

      <p>
        당시 나는 이미 여러 아이돌 공연을 경험하면서 공연이 어떤 순서로 흘러가는지, 어느 순간에
        멘트가 나오고 어떤 식으로 앙코르가 이어지는지에 어느 정도 익숙해졌다고 생각하고 있었다.
      </p>

      <p>그래서 예상에서 벗어나는 순간들이 더 크게 느껴졌다.</p>

      <p>공연이 끝난 뒤에도 하루는 바로 끝나지 않았다.</p>

      <p>
        특별히 완성된 야간 코스를 미리 만들어둔 것은 아니었고, 공연에서 올라간 기분을 따라 걷고,
        먹고, 다시 이동하면서 다음 경험으로 이어갔다.
      </p>

      <p>
        이 글의 제목에 있는 즐거움은 하나의 거대한 사건만을 뜻하지 않는다. 공연장의 강한 자극도
        있고, 우연히 들어간 식당도 있고, 걷는 시간도 있고, 마지막에는 몸을 쉬게 하는 아주 작은
        편안함도 있다.
      </p>
