...
export const seongsuPlanCollapse: Session = {
  ...
  guide: (
    <>
      <p>이날은 시작부터 수면이 부족했다.</p>

      <p>
        전날 늦게까지 여행 중 찍은 사진과 영상을 정리했고, 새벽이 되어서야 잠들었다. 하지만 아침에는
        체크아웃해야 했고 그 상태로 원래 계획해두었던 성수 일정을 시작했다.
      </p>

      <p>중요한 것은 계획이 없었던 게 아니라는 점이다.</p>

      <p>갈 장소도 있었고, 방문 순서도 있었고, 무엇을 할지도 어느 정도 정해져 있었다.</p>

      <p>
        그런데 실제 하루에서는 각 계획이 서로 다른 이유로 실행되지 않는다. 문이 닫혀 있기도 하고,
        이미 다른 곳에서 같은 욕구를 해결하기도 하고, 막상 앞에 도착한 뒤 마음이 바뀌기도 한다.
      </p>

      <p>그리고 그 모든 판단 뒤에 계속 피로가 있다.</p>

      <p>
        그래서 이 페이지에서는 아침에 세워둔 계획을 지워버리지 않는다. 계획은 계속 화면에 남아 있고,
        그 옆에 실제로 일어난 하루가 하나씩 쌓인다.
      </p>
