...
export const onlyMyself: Session = {
  ...
  guide: (
    <>
      <p>이 기록에는 여러 미술관과 예술가가 등장하지만 미술관을 소개하기 위해 만든 글은 아니다.</p>

      <p>
        하루 동안 다른 사람들이 자기 삶과 작품을 어떤 방식으로 다뤘는지를 보고 난 뒤, 오래 가지고
        있던 개인적인 규칙 하나를 다시 보게 된 기록에 가깝다.
      </p>

      <p>후반부에 등장하는 51%는 이날 처음 만들어진 숫자가 아니다.</p>

      <p>
        AI와 함께 무언가를 만들기 시작한 뒤 나는 결과물에 대한 최종 판단과 방향만큼은 내가 가지고
        있어야 한다고 생각했다. 그 상태를 편의상 51%라고 불렀다.
      </p>

      <p>
        AI가 많은 부분을 만들더라도 마지막 선택을 내가 한다면 여전히 내가 주도하는 작업이라고 볼 수
        있다는 기준이었다.
      </p>

      <p>
        이 규칙은 모든 것을 직접 하겠다는 선언이라기보다 내가 어디까지 물러날 수 있는지를 정하는
        기준에 가까웠다.
      </p>

      <p>
        그런데 이날의 경험 뒤에서 그 규칙을 만든 이유와 실제로 지키고 있던 방식 사이에 차이가 있다는
        생각이 생긴다.
      </p>
